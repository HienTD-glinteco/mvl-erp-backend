...
class EmailSendJob(BaseModel):
    ...
    subject = models.CharField(
        ...
        help_text="Subject line for the emails",
    )
    ...
    total = models.PositiveIntegerField(
        ...
        help_text="Total number of recipients in this job",
    )
    sent_count = models.PositiveIntegerField(
        default=0,
        verbose_name="Sent count",
        help_text="Number of successfully sent emails",
    )
    failed_count = models.PositiveIntegerField(
        default=0,
        verbose_name="Failed count",
        help_text="Number of failed email sends",
    )
    ...
    finished_at = models.DateTimeField(
        ...
        help_text="When the job finished processing",
    )
    callback_data = models.JSONField(
        null=True,
        blank=True,
        verbose_name="Callback data",
        help_text="Callback function and object reference to call after successful send",
    )
...
class EmailSendRecipient(BaseModel):
    ...
    data = models.JSONField(
        verbose_name="Template data",
        help_text="Data used to render the template for this recipient",
    )
    callback_data = models.JSONField(
        null=True,
        blank=True,
