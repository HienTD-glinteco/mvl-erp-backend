# Generated by Django 5.2.6 on 2025-12-12 07:22
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Name of the KPI criterion", max_length=255, verbose_name="Criterion name"
                    ),
                ),
                (
                    "description",
                    models.TextField(
                        blank=True, help_text="Detailed description of the criterion", verbose_name="Description"
                    ),
                ),
                (
                ...
                (
                    ...
                    models.PositiveSmallIntegerField(
                        default=0, help_text="Order for sorting and display", verbose_name="Display order"
                    ),
                ),
                (
                    "active",
                    models.BooleanField(
                        default=True, help_text="Whether this criterion is active", verbose_name="Active"
                    ),
                ),
                (
                    "created_by",
            ...
            options={
                ...
                "indexes": [
                    models.Index(fields=["target", "evaluation_type"], name="payroll_kpi_target_c4af82_idx"),
                    models.Index(fields=["active"], name="payroll_kpi_active_c2e4dc_idx"),
                ],
