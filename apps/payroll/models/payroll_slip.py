...
class PayrollSlip(AutoCodeMixin, BaseModel):
    ...
    # ========== KPI Component ==========
    kpi_grade = models.CharField(
        max_length=10,
        default="C",
        verbose_name="KPI Grade"
    )
    ...
    # ========== Sales Performance ==========
    sales_revenue = models.BigIntegerField(
        default=0,
        verbose_name="Sales Revenue"
    )
    
    sales_transaction_count = models.IntegerField(
        default=0,
        verbose_name="Sales Transaction Count"
    )
    
    business_grade = models.CharField(
        max_length=10,
        default="M0",
        verbose_name="Business Grade"
    )
    ...
    saturday_inweek_overtime_hours = models.DecimalField(
        ...
        decimal_places=2,
        default=Decimal("0.00"),
        verbose_name="Saturday & Weekday Overtime Hours"
    )
