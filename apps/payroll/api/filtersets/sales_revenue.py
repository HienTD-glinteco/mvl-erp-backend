...
class SalesRevenueFilterSet(django_filters.FilterSet):
    """FilterSet for SalesRevenue model.

    Provides filtering by month, status, and organizational hierarchy
    ...
    status = django_filters.ChoiceFilter(
        field_name="status",
        choices=SalesRevenue.SalesRevenueStatus.choices,
    )
