...
class DeviceChangeRequestTestCase(TestCase):
    ...
    @patch("apps.core.api.views.auth.device_change.send_otp_email_task.delay")
    def test_verify_otp_creates_proposal(self, mock_email_task):
        ...
        # Get the device request and verify OTP
        device_request = DeviceChangeRequest.objects.get(request_id=request_id)
        ...
        self.assertEqual(proposal.created_by, self.employee)
        ...
        self.assertEqual(proposal.device_change_old_device_id, self.old_device_id)
    ...
    @patch("apps.core.api.views.auth.device_change.send_otp_email_task.delay")
    def test_verify_otp_expired(self, mock_email_task):
