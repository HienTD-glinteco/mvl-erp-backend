    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "reset_token",
                    models.CharField(db_index=True, max_length=64, unique=True, verbose_name="Reset Token"),
                ),
                ("otp_hash", models.CharField(max_length=128, verbose_name="OTP Hash")),
                (
                    "channel",
                    models.CharField(choices=[("email", "Email"), ("sms", "SMS")], default="email", max_length=10),
                ),
