...
class PositionAdmin(admin.ModelAdmin):
    ...
    list_display = ["code", "name", "is_leadership", "include_in_employee_report", "is_active"]
    list_filter = ["is_leadership", "include_in_employee_report", "is_active"]
    search_fields = ["code", "name"]
    readonly_fields = ["code", "created_at", "updated_at"]
    fieldsets = [
        (None, {"fields": ["code", "name", "description"]}),
        ("Settings", {"fields": ["is_leadership", "include_in_employee_report"]}),
