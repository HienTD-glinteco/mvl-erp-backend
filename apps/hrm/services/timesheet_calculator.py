...
class TimesheetCalculator:
    ...
    def _handle_half_day_shift_working_days(self, half_day_shift, daily_max_days) -> bool:
        """Deprecated in favor of _calculate_gross_working_days, kept for reference or removed?
           Removing this method as logic is moved to _calculate_gross_working_days."""
        # This method is now redundant because logic is moved to _calculate_gross_working_days
        # But we need to keep it if other methods call it? No, only called by compute_working_days.
        pass
