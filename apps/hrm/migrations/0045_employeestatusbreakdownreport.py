    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['report_date'], name='hrm_employe_report__da1685_idx'), models.Index(fields=['branch', 'block', 'department'], name='hrm_employe_branch__b02471_idx')],
