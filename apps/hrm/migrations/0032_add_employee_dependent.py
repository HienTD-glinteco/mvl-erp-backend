    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                "ordering": ["-created_at"],
                "indexes": [
                    models.Index(fields=["employee", "is_active"], name="hrm_employe_employe_12d73e_idx"),
                    models.Index(fields=["id_number"], name="hrm_employe_id_numb_1cb2b2_idx"),
                    models.Index(fields=["dependent_name"], name="hrm_employe_depende_7640f0_idx"),
                    models.Index(fields=["relationship"], name="hrm_employe_relatio_3054f9_idx"),
                ],
            },
        ),
    ]
