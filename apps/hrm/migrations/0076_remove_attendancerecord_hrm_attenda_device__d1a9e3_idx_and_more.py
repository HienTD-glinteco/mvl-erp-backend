# Generated by Django 5.2.6 on 2025-11-26 16:18
...
def populate_location_field(apps, schema_editor):
    ...
    for geolocation in AttendanceGeolocation.objects.all():
        if geolocation.latitude is not None and geolocation.longitude is not None:
            ...
            geolocation.location = Point(float(geolocation.longitude), float(geolocation.latitude), srid=4326)
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunPython(populate_location_field, migrations.RunPython.noop),
    ]
