    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(fields=["employee", "certificate_type"], name="hrm_employe_employe_287b98_idx"),
                    models.Index(fields=["certificate_code"], name="hrm_employe_certifi_f69eb7_idx"),
                    models.Index(fields=["issue_date"], name="hrm_employe_issue_d_2a8496_idx"),
                    models.Index(fields=["expiry_date"], name="hrm_employe_expiry__e902ce_idx"),
                ],
            },
        ),
    ]
