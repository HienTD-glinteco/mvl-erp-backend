...
def _get_work_schedule_model():
    """Get WorkSchedule model using lazy loading to avoid circular imports."""
    return apps.get_model("hrm", "WorkSchedule")


def get_all_work_schedules(use_cache: bool = True):
...
def get_work_schedule_by_weekday(weekday: int, use_cache: bool = True):
