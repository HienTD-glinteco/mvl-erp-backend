...
from apps.hrm.constants import ExtendedReportPeriodType, ReportPeriodType
...
class HiredCandidateReportAggregatedSerializer(serializers.Serializer):
    ...
    period_type = serializers.ChoiceField(read_only=True, choices=ReportPeriodType.choices)
    labels = serializers.ListField(child=serializers.CharField(), read_only=True, help_text="Period labels")
...
# Employee Status Breakdown Report Serializers
