...
class RecruitmentCandidateFilterSet(django_filters.FilterSet):
    ...
    status = django_filters.ChoiceFilter(choices=RecruitmentCandidate.Status.choices)
    recruitment_request = django_filters.NumberFilter(field_name="recruitment_request_id")
