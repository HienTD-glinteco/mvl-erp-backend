...
class AttendanceWifiAPITest(TransactionTestCase, APITestMixin):
    """Test cases for AttendanceWifi API endpoints."""

    def setUp(self):
        # Clear all existing data for clean tests
        AttendanceWifi.objects.all().delete()
        ...
        # Create test WiFis
        self.wifi1 = AttendanceWifi.objects.create(
        ...
        self.wifi2 = AttendanceWifi.objects.create(
    ...
    def test_list_wifis(self):
        """Test listing all attendance WiFis."""
        url = reverse("hrm:attendance-wifi-list")
    ...
    def test_retrieve_wifi(self):
        ...
        url = reverse("hrm:attendance-wifi-detail", kwargs={"pk": self.wifi1.pk})
        response = self.client.get(url)
    ...
    def test_delete_wifi(self):
        ...
        with self.assertRaises(AttendanceWifi.DoesNotExist):
            AttendanceWifi.objects.get(pk=self.wifi1.pk)
