...
class TestContractModel:
    ...
    def test_create_contract(self, db, employee, contract_type):
        ...
        # Code format: xx/yyyy/abc - MVL
        assert " - MVL" in contract.code
        # contract_number is a property that returns code
        assert contract.contract_number == contract.code
    ...
    def test_contract_auto_code_generation(self, db, employee, contract_type):
        ...
        # Code format: xx/yyyy/abc - MVL
        assert " - MVL" in contract.code
        assert f"/{date.today().year}/" in contract.code
        assert contract_type.symbol in contract.code
    ...
    def test_contract_number_property(self, contract):
        """Test contract_number property returns code."""
        assert contract.contract_number == contract.code
...
class TestContractCodeGeneration:
    ...
    def test_generate_contract_code(self, db, employee, contract_type):
        ...
        assert contract_type.symbol in code
...
class TestContractAPI:
    ...
    def test_retrieve_contract(self, api_client, contract):
        ...
        # contract_number is a property that returns code
        assert data["contract_number"] == contract.code
    ...
    def test_create_contract(self, api_client, contract_data):
        ...
        # Code format: xx/yyyy/abc - MVL
        assert " - MVL" in data["code"]
        # contract_number is same as code
        assert data["contract_number"] == data["code"]
