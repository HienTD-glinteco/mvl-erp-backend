...
class RelationshipResolver:
    ...
    def resolve_foreign_key(
        ...
        try:
            ...
            logger.exception("Unexpected error in resolve_foreign_key")
            pass
        ...
        for field_name in ["name", "code", "email", "username"]:
            if field_name != lookup_field and hasattr(model, field_name):
                try:
                    ...
                    logger.exception(f"Unexpected error looking up {field_name}")
                    continue
        ...
        try:
            ...
            logger.exception("Unexpected error in resolve_foreign_key (iexact lookup)")
            pass
